...
@section('content')
    <section class="mt-0 ">
        <!-- Bordered Table -->
        <div class="card shadow-lg border-0 mb-4" style="background: linear-gradient(135deg, #28a745, #218838); color: white;">
            <div class="card-body d-flex align-items-center">
                ...
                <div>
                    <!-- Title -->
                    <h5 class="card-title fw-bold text-dark">Paid Transactions</h5>
                    <!-- Content -->
                    <p class="card-text mb-0">
                        Number of transactions that have been paid:
                    </p>
