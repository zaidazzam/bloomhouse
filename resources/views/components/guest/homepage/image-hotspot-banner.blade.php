        ...
        <section class="my-10 position-relative">
            ...
            <div class="w-100 h-80 bg-img-cover bg-pos-center-center hotspot-container py-5 py-md-7 py-lg-10" style="background-image: url(assets/images/banners/footer.png);">
                ...
                <div class="container py-lg-8 position-relative z-index-10 d-flex align-items-center" data-aos="fade-left">
                    <div class="py-8 d-flex justify-content-end align-items-start align-items-lg-end flex-column col-lg-4 text-lg-end">
                        {{-- <p class=" text-black fw-bolder text-uppercase tracking-wider mb-2 text-muted">The best moment for you</p> --}}
                        <h2 class="display-5 fw-bold mb-3">Beautiful Flowers</h2>
                        <p class="lead d-none d-lg-block">Flowers From The Best Rated Local Florists</p>
                        <a class="text-decoration-none fw-bolder" href="/category">Shop The Bloom House &rarr;</a>
                    </div>
                </div>
                    ...
                    <div class="m-n2 rounded overflow-hidden">
                        <div class="mb-1 bg-light d-flex justify-content-center">
                            <div class="f-w-48 px-3 pt-3">
                                <img class="img-fluid" src="./assets/images/products/bunga3.jpg" alt="Bootstrap 5 Template by Pixel Rocket">
                            </div>
                        </div>
            ...
            <div class="rating position-relative d-table">
                ...
                <div class="stars">
                    ...
                    <i class="ri-star-fill mr-1 text-muted opacity-25"></i>
                            ...
                            <p class="mb-0 mx-4">Flowers Roses</p>
                            <p class="lead lh-1 m-0 fw-bolder mt-2 mb-3">Rp. 150.000</p>
                            <a href="./category" class="fw-bolder text-link-border pb-1 fs-6">Full details <i class="ri-arrow-right-line align-bottom"></i></a>
                        </div>
                    </div>
                </div>
            </div>
