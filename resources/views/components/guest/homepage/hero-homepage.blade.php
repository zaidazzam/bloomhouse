                ...
                <div
                    ...
                    <div>
                        <h1 class="display-1 fw-bold px-2 px-md-5 text-center mx-auto col-lg-8 mt-md-0"
                            data-aos="fade-up" data-aos-delay="1000">The Best Flowers Your Can Find</h1>
                        <div data-aos="fade-in" data-aos-delay="2000">
                            <div class="d-md-flex justify-content-center mt-4 mb-3 my-md-5">
                                <a href="/category"
                                    class="btn btn-skew-left btn-twitter btn-twitter-chunky text-white mx-1 w-100 w-md-auto mb-2 mb-md-0"><span>Shop
                                        Flowers <i class="ri-arrow-right-line align-middle fw-bold"></i></span></a>
                                <a href="/category"
                                    class="btn btn-skew-left btn-twitter btn-twitter-chunky text-white mx-1 w-100 w-md-auto mb-2 mb-md-0"><span>Shop
                                        Occasions<i class="ri-arrow-right-line align-middle fw-bold"></i></span></a>
                            </div>
                ...
                <div class="swiper-container overflow-hidden bg-light w-100 h-100"
                  ...
                  <div class="swiper-wrapper">
                    <div class="swiper-slide position-relative">
                      <div class="w-100 h-100 bg-img-cover animation-move bg-pos-center-center" style="background-image: url(./assets/images/slideshows/banerbunga.jpg);">
                      </div>
                    </div>
                    <div class="swiper-slide position-relative">
                      <div class="w-100 h-100 bg-img-cover animation-move bg-pos-center-center" style="background-image: url(./assets/images/slideshows/banerbunga1.jpg);">
                      </div>
                    </div>
                    <div class="swiper-slide position-relative">
                      <div class="w-100 h-100 bg-img-cover animation-move bg-pos-center-center" style="background-image: url(./assets/images/slideshows/banerbunga2.jpg);">
                      </div>
                    </div>
                  </div>
