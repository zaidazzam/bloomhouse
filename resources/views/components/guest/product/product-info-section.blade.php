                <div class="col-12 col-lg-5">
                    <div class="pb-3">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <p class="small fw-bolder text-uppercase tracking-wider text-muted mb-0 lh-1">Floowers</p>
                        ...
                        <h1 class="mb-2 fs-2 fw-bold">Flowers Love Rose</h1>
                        <div class="d-flex justify-content-start align-items-center">
                            <p class="lead fw-bolder m-0 fs-3 lh-1 text-danger me-2">Rp.84.909</p>
                            <s class="lh-1 me-2"><span class="fw-bolder m-0">Rp.94.990</span></s>
                            <p class="lead fw-bolder m-0 fs-6 lh-1 text-success">Save Rp 10.000</p>
                        </div>
                        <!-- /Product Name, Review, Brand, Price-->
