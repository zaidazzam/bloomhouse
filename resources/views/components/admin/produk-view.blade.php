                       ...
                       <td>
                        ...
                        <td>
                            ...
                            <div class='dropdown-menu'>
                                ...
                                <form method="POST" action="{{ route('product_products.destroy',$product->id) }}">
                                    @method('DELETE')
                                    @csrf
...
<div class="modal fade" id="productModal" data-bs-backdrop="static" tabindex="-1">
    <div class="modal-dialog">
        <form class="modal-content" method="POST" action="{{ route('product_products.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        ...
                        <select class="form-select" aria-label="Default select example" name="category_id" id="productCategory">
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        ...
                        <input type="number" name="product_stock" id="productStock" class="form-control" placeholder="Enter Stock" />
                    </div>
                    <div class="col-6">
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        ...
                        <input type="number" name="product_price" id="productPrice" class="form-control" placeholder="Enter Price" />
                    </div>
                    <div class="col-6">
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        ...
                        <textarea name="product_description" id="editProductDescription" class="form-control" placeholder="Enter Description"></textarea>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-6">
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        editButtons.forEach(button => {
            button.addEventListener('click', function () {
                    ...
                    const categoryId = row.querySelector('[data-category]').getAttribute('data-category');
                    ...
                    if (categoryId) {
                        const optionToSelect = categorySelect.querySelector(`option[value="${categoryId}"]`);
                        if (optionToSelect) {
            ...
            photoButtons.forEach(button => {
                button.addEventListener('click', function () {
                    const row = this.closest('tr'); 
                    const url = row.querySelector('[data-photo-url]').getAttribute('data-photo-url');
                    ...
                    const list_photo_raw = row.querySelector('[list-pict]').getAttribute('list-pict');
                    let list_photo = [];
                    try {
