          ...
          <div class="card-body">
            ...
            <div class="d-flex flex-column align-items-center mt-3">
              <div class="custom-control custom-radio">
                <input type="radio" id="package1" name="package" value="120000" class="custom-control-input required">
                <label for="package1" class="custom-control-label">
                  <span class="btn btn-primary text-white">Choose</span>
                </label>
                <p class="text-success m-0 mt-2" style="display: none;">
      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm">
          ...
          <div class="card-body">
            ...
            <div class="d-flex flex-column align-items-center mt-3">
              <div class="custom-control custom-radio">
                <input type="radio" id="package2" name="package" value="220000" class="custom-control-input required">
                <label for="package2" class="custom-control-label">
                  <span class="btn btn-primary text-white">Choose</span>
                </label>
                <p class="text-success m-0 mt-2" style="display: none;">
                  <i class="fa fa-check"></i> Terpilih
      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm">
          ...
          <div class="card-body">
            ...
            <div class="d-flex flex-column align-items-center mt-3">
              <div class="custom-control custom-radio">
                <input type="radio" id="package3" name="package" value="320000" class="custom-control-input required">
                <label for="package3" class="custom-control-label">
                  <span class="btn btn-primary text-white">Choose</span>
                </label>
                <p class="text-success m-0 mt-2" style="display: none;">
                  <i class="fa fa-check"></i> Terpilih
        ...
        element.innerHTML = `
                ...
                <div class="card mb-4 rounded-3 shadow-sm">
                    ...
                    <div class="d-flex justify-content-center align-items-center mt-3">
                        <div class="custom-control custom-radio">
                        <input type="radio" id="package1" name="package" value="150000" class="custom-control-input required">
                        <label for="package1" class="custom-control-label">
                            <a class="fs-18 pointer btn btn-primary text-white">Choose</a>
                        </label>
                        <p class="text-success m-0 ms-2" style="display: none;">
                            <i class="fa fa-check"></i> Terpilih
                        </p>
                        </div>
                    </div>
               ...
               <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="d-flex flex-column align-items-center mt-3">
                            <div class="custom-control custom-radio">
                            <input type="radio" id="package2" name="package" value="250000" class="custom-control-input required">
                            <label for="package2" class="custom-control-label">
                                <span class="btn btn-primary text-white">Choose</span>
                            </label>
                            <p class="text-success m-0 mt-2" style="display: none;">
               ...
               <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    ...
                    <div class="d-flex flex-column align-items-center mt-3">
                        <div class="custom-control custom-radio">
                        <input type="radio" id="package3" name="package" value="350000" class="custom-control-input required">
                        <label for="package3" class="custom-control-label">
                            <span class="btn btn-primary text-white">Choose</span>
                        </label>
                        <p class="text-success m-0 mt-2" style="display: none;">
...
document
    .querySelector("#modalEditVehicle")
    .addEventListener("show.bs.modal", function (event) {
        ...
        var vehicleTypeOption = modal.querySelector(
            '#vehicleType option[value="' + vehicleTypeSelect + '"]'
        );
        vehicleTypeOption.selected = true;
        var vehicleTransmissionOption = modal.querySelector(
            '#vehicleTransmission option[value="' + transmissionSelect + '"]'
        );
...
document
    .querySelector("#modalEditSparepart")
    .addEventListener("show.bs.modal", function (event) {
        var button = event.relatedTarget; // Button that triggered the modal
...
document
    .querySelector("#modalEditBooking")
    .addEventListener("show.bs.modal", function (event) {
        var button = event.relatedTarget; // Button that triggered the modal
        ...
        var modal = this;
        var bookingStatusSelect =
            bookingStatus == "stand_by" ? "1" : "on_process" ? "2" : "3";
        var bookingStatusOption = modal.querySelector(
            '#statusEdit option[value="' + bookingStatusSelect + '"]'
        );
